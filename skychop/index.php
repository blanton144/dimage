...
<!--<font class='errorText'><b>Current Status:</b> </font><font color='#00CC00'>Online for testing</font>-->
<br />
	...
	<td>
      <form method='GET' name='imageChop'>
          <table border='0' align="center">
              ...
              <tr>
                  <td colspan="2" align="center"><font class='theLabels'>Generate PNG thumbnail:</font>
                      <?php 
                          if ($_POST['tyn'] == 'on') {
