...
results and SDSS at bright magnitudes.  However, for faint objects we
err on the bright side, probably a sign that we have not subtracted
the local sky. {\bf but maybe we should for this comparison?}
...
\bibliographystyle{../../ccpp-latex/apj}
\bibliography{../../ccpp-latex/apj-jour,../../ccpp-latex/ccpp}
