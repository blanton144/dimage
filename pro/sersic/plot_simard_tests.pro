...
;-
;------------------------------------------------------------------------------
pro plot_simard_tests

filebase='vA'
outdir= getenv('DIMAGE_DIR')+'/tex'

all= mrdfits(filebase+'-test.fits',1)
...
filebase=outdir+'/test-simard-petro-flux'
...
filebase=outdir+'/test-simard-petro-r50'
k_print, filename=filebase+'.ps'
!P.MULTI=[3,1,3]
!Y.MARGIN=5
!X.OMARGIN=[20, 0]
...
;; Make Petro size comparisons
filebase=outdir+'/test-simard-petro-r50-big'
k_print, filename=filebase+'.ps'
!P.MULTI=[3,1,3]
!Y.MARGIN=5
!X.OMARGIN=[20, 0]
...
;; Make Petro size comparisons
filebase=outdir+'/test-simard-petrocirc-r50'
k_print, filename=filebase+'.ps'
!P.MULTI=[3,1,3]
!Y.MARGIN=5
!X.OMARGIN=[20, 0]
...
;; Make Petro size comparisons
filebase=outdir+'/test-simard-petrocirccirc-r50'
k_print, filename=filebase+'.ps'
!P.MULTI=[3,1,3]
!Y.MARGIN=5
!X.OMARGIN=[20, 0]
...
;; Make Petro flux comparisons
filebase=outdir+'/test-simard-petrocirc-flux'
k_print, filename=filebase+'.ps'
!P.MULTI=[3,1,3]
!Y.MARGIN=5
!X.OMARGIN=[20, 0]
...
;; Make Petro size comparisons
filebase=outdir+'/test-simard-petro-rad'
k_print, filename=filebase+'.ps'
!P.MULTI=[3,1,3]
!Y.MARGIN=5
!X.OMARGIN=[20, 0]
...
filebase=outdir+'/test-simard-sersic-flux'
k_print, filename=filebase+'.ps'
!P.MULTI=[3,1,3]
!Y.MARGIN=5
!X.OMARGIN=[20, 0]
...
filebase=outdir+'/test-simard-sersic-r50'
k_print, filename=filebase+'.ps'
!P.MULTI=[3,1,3]
!Y.MARGIN=5
!X.OMARGIN=[20, 0]
